...
export class SideBarNavComponent extends AppComponentBase {
    ...
    menuItems: MenuItem[] = [
        ...
        new MenuItem(this.l('Category'), 'Administration.Categories', 'category', '/app/tenant/category'),
        new MenuItem(this.l('State'), 'Administration.States', 'location_city', '/app/states'),

        new MenuItem(this.l('Profile'), 'Tenant', 'business', '/app/tenant'),
        new MenuItem(this.l('Branch'), 'Branch', 'location_city', '/app/branches'),

        new MenuItem(this.l('VoucherPlatform'), 'VoucherPlatform', 'card_giftcard', '/app/voucher-platform'),
