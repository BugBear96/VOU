...
namespace VOU.EntityFrameworkCore.Seed.Host
{
    public class DefaultLanguagesCreator
    {
        public static List<ApplicationLanguage> InitialLanguages => GetInitialLanguages();

        private readonly VOUDbContext _context;

        private static List<ApplicationLanguage> GetInitialLanguages()
        {
            var tenantId = VOUConsts.MultiTenancyEnabled ? null : (int?)MultiTenancyConsts.DefaultTenantId;
        ...
        public DefaultLanguagesCreator(VOUDbContext context)
        {
            _context = context;
        }
